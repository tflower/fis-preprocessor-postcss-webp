...
var _node = require('node_modules/postcss/lib/node.js');
...
var Container = function (_Node) {
    ...
    Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
            var parse = require('node_modules/postcss/lib/parse.js');
            ...
            var Rule = require('node_modules/postcss/lib/rule.js');
            nodes = [new Rule(nodes)];
        } else if (nodes.name) {
            var AtRule = require('node_modules/postcss/lib/at-rule.js');
